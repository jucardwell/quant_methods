...
In this chapter, we will build on the descriptive tools we learned in the Describing Data chapter. Spatial descriptive statistics summarize spatial patterns, not just patterns in value.

We will use the following spatial data:

-   Grocery stores in Wake County

-   

**To follow along with this tutorial, save this data into your "data" subfolder in your "describing data" folder. Create and dave a new .Rmd called "describing_spatial_data.Rmd" in your "desciribing data folder". Whenever you see lines of code, copy them into your own .Rmd.**

**North Carolina census tract rurality definitions (RUCA codes) from the USDA Economic Research Service and North Carolina Rural Center.** These two sources offer differing definitions of rurality. RUCA codes establish urban cores and the census tracts that are the most economically integrated with those cores through commuting. The North Carolina Rural Center defines rurality by a population density threshold (rural \< 250 people per square mile).
...
**To follow along with this tutorial, create a folder called "describing_data" and a subfolder called "data". Save the data into the "data" subfolder, and create and save a .Rmd called "describing_data.Rmd" in the "describing_data" folder. Whenever you see lines of code, copy these into your own document.**

![](images/describing_data.png)
...
1.  Open the acs_tract_nc object. You can scroll over to see all the available variables. The "data_dict_acs.xlsx" file (which should be saved in your data folder) will tell you what each variable name means.
2.  Select a variable that is interesting to you
3.  Using the code above, as well as the R Basics chapter, create a descriptive statistics table in a new code chunk
...
6.  Answer the following questions:
    -   What did you learn about your variable?
    -   What did you learn about the spatial pattern of your variable?
