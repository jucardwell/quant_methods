...
**I will provide you a .Rmd template to use for each in-class exercise and lab. You should save these files into a GEOG391 folder on your computer (not in the downloads folder please!)**
...
Download your first .Rmd template for this class **(very exciting)! Save this file into your GEOG391 folder.**
